...
public class PolicyHandler{
    ...
    public void wheneverOrderPlaced_AlertViaKakao(@Payload OrderPlaced orderPlaced){
    ...
    @StreamListener(value=KafkaProcessor.INPUT, condition="headers['type']=='PublishedCoupon'")
    public void wheneverPublishedCoupon_AlertViaKakao(@Payload PublishedCoupon publishedCoupon){
